...
type WorkspacePersistenceFile = {
	path: string;
	content: string;
	stableId: string | null;
};
type WorkspaceCreateAttemptInventory = {
	"status": "found";
	root: string;
	workspaceId: string;
} | {
...
type WindowInfo = {
	...
	*/
	selectedAgentTerminalId?: WindowTerminalId | null;
	/**
...
type OmpCompanionCommandTargetV1 = {
	incarnation: string;
...
type RemoteAttachRequest = Promise<RemoteAttachResult> & {
	readonly requestId: number;
	cancel(): void;
};
type CompositeCursorInfo = {
	focusedPane: number;
	paneCount: number;
...
interface EditorAPI {
	...
	*/
	getCompositeCursorInfo(): Promise<CompositeCursorInfo | null>;
	/**
	...
	*/
	removeFileTo(windowId: number, path: string): boolean;
	/**
	...
	*/
	activateWindow(id: number): Promise<boolean>;
	/**
	...
	*/
	inspectWorkspacePersistence(root: string): Promise<WorkspacePersistenceFile[]>;
	/**
	...
	*/
	inspectWorkspaceCreateAttempt(attemptId: string, rootHint: string | null, workspaceIdHint: string | null): Promise<WorkspaceCreateAttemptInventory>;
	/**
	...
	*/
	forgetWorkspacePersistence(root: string, stableId: string | null): Promise<void>;
	/**
	...
	*/
	quarantineWorkspaceArtifacts(root: string, stableId: string | null, ownerId: string): Promise<void>;
	/**
	* Restore a staged artifact namespace at the supplied current root.
	*/
	restoreWorkspaceArtifacts(targetRoot: string, stableId: string | null, ownerId: string): Promise<void>;
	/**
	...
	*/
	setWindowStateTo(windowId: number, key: string, value: unknown): boolean;
	/**
	...
	*/
	attachRemoteAgent(payload: RemoteAgentSpec): RemoteAttachRequest;
	/**
	* Cancel one caller-owned in-flight `attachRemoteAgent` request.
	*/
	cancelRemoteAgent(requestId: number): void;
	/**
